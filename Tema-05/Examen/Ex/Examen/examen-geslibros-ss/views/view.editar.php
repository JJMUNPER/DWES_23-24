        ...
        <form action="update.php?id=<?= $id_editar ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" aria-describedby="emailHelpId" placeholder="0"
                        name="paginas">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" aria-describedby="emailHelpId" step="0.01"
                        placeholder=0.00 name="precio_coste">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" aria-describedby="emailHelpId" step="0.01"
                        placeholder=0.00 name="precio_venta">
                </div>
