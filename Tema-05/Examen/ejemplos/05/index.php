<?php
    ...
    */
    ...
    /*
        Con la constante MYSQLI_NUM indicamos la forma en la que extraeremos los datos
        en este caso, mediante un array con indice enumerado
    */
    $alumnos = $result->fetch_all(MYSQLI_NUM);

    // Array indexado, el indice se corresponde con el orden de cada columna en la tabla alumnos
    $alumno = $alumnos[0];
