    ...
    <div class="row justify-content-center">
            ...
            <?php require_once("template/partials/error.php") ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="https://educacionadistancia.juntadeandalucia.es/centros/cadiz/pluginfile.php/409260/mod_assign/introattachment/0/<?=URL?>perfil/delete ?>">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-9 offset-sm-3">
                                    <a class="btn btn-secondary" href="https://educacionadistancia.juntadeandalucia.es/centros/cadiz/pluginfile.php/409260/mod_assign/introattachment/0/<?=URL?>alumnos" role="button">Cancelar</a>
