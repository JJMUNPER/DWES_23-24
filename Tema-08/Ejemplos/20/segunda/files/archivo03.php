                        ...
                        <form method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-9 offset-sm-3">
                                    <button type="submit" class="btn btn-primary" formaction="<?=URL?>editperfil/validate">Enviar</button>
                                    <a class="btn btn-secondary" href="https://educacionadistancia.juntadeandalucia.es/centros/cadiz/pluginfile.php/409260/mod_assign/introattachment/0/<?=URL?>corredores" role="button">Cancelar</a>
