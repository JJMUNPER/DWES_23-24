    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (in_array($_SESSION['id_rol'], $GLOBALS['clientes']['import'])) ? 'activate' : 'disabled' ?>"
                        aria-current="page" href="<?= URL ?>clientes/importar">Importar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= (in_array($_SESSION['id_rol'], $GLOBALS['clientes']['export'])) ? 'activate' : 'disabled' ?>"
                        aria-current="page" href="<?= URL ?>clientes/exportar">Exportar</a>
                </li>
