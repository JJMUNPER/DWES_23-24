...
class clientesModel extends Model
{
    ...
    public function get()
    {
        ...
        ORDER BY 
            ...
            # establecemos  tipo fetch(objeto)
            $pdoSt->setFetchMode(PDO::FETCH_OBJ);
            # ejecutamos
            $pdoSt->execute();
            # devolvemos el resultado (objeto)
            return $pdoSt;
    ...
    public function update(classCliente $cliente, $id)//Pasar tipo de dato id?
    {
        try {
            $sql = " 
                    UPDATE clientes
    ...
    {
        try {
            # eliminamos cuenta del cliente en la tabla Cuentas
