...
class Clientes extends Controller
{
    ...
    public function create($param = [])
    {
        ...
        # 1. Inicioamos o continuamos session
        session_start();
        ...
        if (!isset($_SESSION['id'])) {
            ...
            // Teléfono. No obligatorio con expresión regular
            $tel = [
                'options' => [
                    'regexp' => '/^[0-9]{9}$/'
                ]
    ...
    public function delete($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            #id cliente a borrar
            $idCliente = $param[0];
            $cuentaCliente = $this->model->getCuentaCliente($idCliente);

            #Eliminar cualquier cuenta que tenga el cliente
            foreach ($cuentaCliente as $cuenta) {
                $this->model->deleteCuenta($cuenta->id);
            }
            #Elimins cliente
