                ...
                <?php foreach ($this->cuentas as $cuenta): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= URL ?>cuentas/listaMovimientos/<?= $cuenta->id ?>" title="listaMovimientos" class="btn btn-info <?= (!in_array($_SESSION['id_rol'], $GLOBALS['cuentas']['listaMovimientos'])) ? 'disabled' : '' ?>">
