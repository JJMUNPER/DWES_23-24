...
class cuentasModel extends Model
{
    ...
    #Metodo getCsv()
    #Lee los datos de la tabla cuentas para la creacion de un CSV con todos las cuentas
    #(No Obligatorio)
    function getCSV()
    {
    ...
    #Metodo movimientosCuenta
    #Lee los movimentos de la cuenta
    public function movimientosCuenta($idC)
    {
        try {
            #Comando SQL
            $sql = "SELECT 
